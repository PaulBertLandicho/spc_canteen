...
<div class="icon-container">
    <div class="iconbar">
        ...
        <a href="category7.php" style="text-decoration: none;"><img src="https://cdn.icon-icons.com/icons2/3277/PNG/512/salad_bowl_food_vegetables_vegan_healthy_food_icon_208011.png" alt="Home"><div class="icon-text" style="color: black;">Healthy</div></a>&nbsp;&nbsp;
    </div>
</div>
<br>
...
<center><h3 style="font-size: 20px; font-weight: bold;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-size: 15px; font-weight: normal;">Healthy</span>
</h3></center>
<br>
...
<center><div id="product-list-container">
    <div id="product-list">
        ...
        $sql = "SELECT * FROM product WHERE category = 7"; // Assuming category number 1 corresponds to category_id in the product table
        $result = $conn->query($sql);
