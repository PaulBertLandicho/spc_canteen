...
<div class="icon-bar">
<a class="active" ><span class="fa fa-dashboard ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<class style="color: black;">Dashboard</span></a><br> 
...
<h2><b>Hello Admin!</b></h2><br><br> 
    <div class="container shadow" style="max-width: 1200px; margin-top: 0px; height:50px; background-color: white; border-radius: 17px;">
   <br<<br><br><br><br><br>
    <center><div class="container shadow" style="max-width: 1200px; margin-top: 0px; height:500px; background-color: white; border-radius: 17px;">
