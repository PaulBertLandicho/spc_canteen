...
<div class="icon-container">
    <div class="iconbar">
        ...
        <a href="category4.php" style="text-decoration: none;"><img src="https://cdn2.iconfinder.com/data/icons/food-72/192/.svg-12-512.png" alt="Home"><div class="icon-text" style="color: black;">Beverage</div></a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<center><h3 style="font-size: 20px; font-weight: bold;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-size: 15px; font-weight: normal;">Beverage</span>
</h3></center>
<br>
...
<center><div id="product-list-container">
    <div id="product-list">
        ...
        $sql = "SELECT * FROM product WHERE category = 4"; // Assuming category number 1 corresponds to category_id in the product table
        $result = $conn->query($sql);
